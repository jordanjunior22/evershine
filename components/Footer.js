    ...
    <footer className="bg-primary text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-6">
        ...
        <div className="mb-6 md:mb-0 w-full md:w-1/4">
          <h3 className="text-lg font-bold mb-2">Evershine Cleaning Services</h3>
          ...
          <div className="flex items-center mb-2">
            ...
            <span className="text-sm">info@evershinecleaning.com</span>
          </div>
          <div className="flex items-center mb-2">
        ...
        <div className="mb-6 md:mb-0 w-full md:w-1/4">
          ...
          <form className="flex">
            ...
            <button className="bg-lightTeal text-white p-2 rounded-r-lg hover:bg-lightTeal-dark">Subscribe</button>
          </form>
        </div>
      </div>
      ...
      <div className="border-t border-lightTeal mt-10 pt-4 text-sm text-center">
        <p>&copy; {new Date().getFullYear()} Evershine Cleaning Services. All rights reserved.</p>
      </div>
    </footer>
  );
};
